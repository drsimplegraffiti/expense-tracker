...
import com.codemonk.expense.services.TransactionService;
...
public class TransactionResource {
    ...
    public ResponseEntity<Transaction> addTransaction(HttpServletRequest request, @PathVariable("categoryId") Integer categoryId,
                                                      @RequestBody Map<String, Object> transactionMap) throws EtBadRequestException {
        int userId = (Integer) request.getAttribute("userId");
    ...
    public ResponseEntity<Map<String, Boolean>> deleteTransaction(HttpServletRequest request,
                                                                  @PathVariable("categoryId") Integer categoryId,
                                                                  @PathVariable("transactionId") Integer transactionId) throws EtBadRequestException {
        int userId = (Integer) request.getAttribute("userId");
